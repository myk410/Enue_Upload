...
function init() {
    ...
    document.querySelector("#takeVideo").addEventListener("touchend", function() {
        ...
        navigator.device.capture.captureVideo(captureSuccess, captureError, {limit: 1, saveToPhotoAlbum: true});
    }, false);

document.querySelector("#Album").addEventListener("touchend", function getPhoto(source) {
